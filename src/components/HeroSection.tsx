...
import { BigGlassCard } from '@/components/ui/big-glass-card';
...
const HeroSection = ({ onVideoComplete }: HeroSectionProps) => {
  ...
  return (
    ...
    >
  {/* Removed black overlay layer as requested */}
      ...
      {showContent && (
        ...
        <section className="relative h-screen flex items-center justify-center text-center text-white overflow-hidden" style={{ background: 'transparent' }}>
          ...
          <BigGlassCard className="relative z-10 p-8 max-w-5xl mx-auto" gradient opacity="light" blur="lg">
