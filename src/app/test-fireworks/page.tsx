...
const MODEL_OPTIONS = [
  { label: "Fireworks Llama-3 8B", value: "accounts/fireworks/models/llama-v3-8b-instruct" },
  { label: "Fireworks Mixtral 8x7B", value: "accounts/fireworks/models/mixtral-8x7b-instruct" },
  { label: "Fireworks Kimi K2 Instruct", value: "accounts/fireworks/models/kimi-k2-instruct" },
  { label: "Fireworks Mistral 7B", value: "accounts/fireworks/models/mistral-7b" },
];

const TestFireworksChat: React.FC = () => {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    setIsLoading(true);
    try {
      const res = await fetch("/api/test-fireworks", {
        method: "POST",
      ...
      <div className="p-4 bg-black/20 border-b border-white/10">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-white text-xl font-semibold">Fireworks Chatbot</h3>
            <p className="text-white/60 text-sm">Test Fireworks API with chat UI</p>
          </div>
          <div>
            <select
...
export default TestFireworksChat;
